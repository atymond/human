...
\item zapewnienia wsparcia medycznego w przypadku możliwości eskalacji sytuacji (na przykład niepokojowych kontrmanifestacji),
...
Firma będzie miała stronę internetową i reklamowała się głównie za pomocą mediów społecznościowych. W celu realizacji wyżej wymienionych elementów, wraz ze wzrostem skali przedsięwzięcia stworzony zostanie system informatyczny do wewnętrznego, który automatyzuje wysyłanie zawiadomień o zgromadzeniu, a także w dużym stopniu organizację transportu i noclegów. Ponadto, system podpowiada najlepsze opcje dotyczące czasu i lokalizacji lub trasy zgromadzenia, oraz wstępne sugestie dotyczące sloganów.
